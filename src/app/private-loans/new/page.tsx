...
import { PRIVATE_LOAN_WORKSPACE_CONFIG } from '@/components/workspace/WorkspaceConfig';

export default function NewPrivateLoanAssetPage() {
  return (
      ...
      <main className="max-w-screen-xl mx-auto px-6 py-6">
        <div className="max-w-2xl">
          <div className="bg-[#131316] border border-[#26262B] rounded-xl p-6">
            <WorkspaceAssetForm action={createPrivateLoanAsset} config={PRIVATE_LOAN_WORKSPACE_CONFIG} />
          </div>
        </div>
      </main>
    </div>
