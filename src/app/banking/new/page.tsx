...
import { BANKING_WORKSPACE_CONFIG } from '@/components/workspace/WorkspaceConfig';

export default function NewBankAssetPage() {
  return (
      ...
      <main className="max-w-screen-xl mx-auto px-6 py-6">
        <div className="max-w-2xl">
          <div className="bg-[#131316] border border-[#26262B] rounded-xl p-6">
            <WorkspaceAssetForm action={createBankAsset} config={BANKING_WORKSPACE_CONFIG} />
          </div>
        </div>
      </main>
    </div>
